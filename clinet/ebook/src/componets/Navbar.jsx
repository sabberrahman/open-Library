...
const Navbar = () => {
  ...
  const Navitems = ( <>
    ...
    return (
        <div className='m max-w-screen-2xl container mx-auto md:px-20 px-4  fixed top-0 left-0 right-0 scroll-smooth focus:scroll-auto z-10 dark:bg-gray-100 dark:text-gray-950 '>
            <div className="navbar bg-base-100 dark:bg-gray-100 dark:text-gray-950">
  <div className="navbar-start">
    <div className="dropdown">
      <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
      </div>
      <ul tabIndex={0} className="menu menu-md dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box text-white w-60">
        {Navitems}
      </ul>
    </div>
...
<div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 font-mono text-xl ">
      {Navitems}
    </ul>
  </div>
