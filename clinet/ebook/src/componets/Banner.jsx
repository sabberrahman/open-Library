    ...
    return (
        <>
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
                <div className=' order-2 w-full md:w-1/2 mt-12 md:mt-24 md:order-1'>
                    <div className='s md:space-y-10 space-y-8'>
                        <h1 className='text-4xl font-bold'>Hello , welcome here to Learn something <span className='t text-pink-700'> new everyday!!!</span></h1>
                ...
                <div className='w-full md:w-1/2 order-1'>
                    <img src="/OIP (1).jpg" alt="" className=' rounded-md md:w-92 md:h-92 md:m-10 mt-5 o ' />
                </div>
            </div>
        </>
    );
